 ...
 <%-- Content 내용들어 갈자리 --%>   
			...
			<table>
				...
				<tbody>
					...
					<tr>
						<th>${e.index+1 }번 설문문항 ${i.subtype }</th>
						<td><input type="radio" name="checktitle" value="${i.subtype }" class="checktitle">${i.surveytitle } => ${i.surveycnt }명</td>
					</tr>
					</c:forEach>
				</tbody>
				<tfoot>
					<tr>
						...
						<input type="button" id="list" value="리스트로">
